...
public class Prediction {
    ...
    public Prediction(String preVersion, String nextVersion, String form, String classifier) {
    ...
    public void loadFiles(String targetVersion) {
        if (this.loadedVersion == null || !this.loadedVersion.equals(targetVersion)) {
            ...
            String filename = main.Main.prefix + "prediction_data" + File.separator + targetVersion + File.separator + this.form + File.separator + "candidates.txt";
    ...
    public void predict() throws Exception {
        String trainFileName = main.Main.prefix + "prediction_data" + File.separator + this.nextVersion + File.separator + this.form + File.separator + "training" + File.separator + "train.csv";
        //训练集文件 train.csv
        File trainFile = new File(trainFileName);
        this.loadFiles(this.nextVersion);
        //建立结果文件夹results/Logistic
        List<List<Integer>> ranks = new ArrayList();
        String resultFile = main.Main.prefix + "prediction_data" + File.separator + this.nextVersion + File.separator + this.form + File.separator + "results";
        ...
        while (true) {
            ...
            while (iterator.hasNext()) {
                ...
                if (!isHit(potential, inducing)) {
                    ...
                    String testFileName = Main.prefix + "prediction_data" + File.separator + File.separator + this.nextVersion + File.separator + this.form + File.separator + "testing" + File.separator + bid + ".csv";
